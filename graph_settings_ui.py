...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.ok_btn, 6, 0, 1, 1)
        ...
        self.axis_label_color_btn = QtWidgets.QPushButton(Dialog)
        self.axis_label_color_btn.setObjectName("axis_label_color_btn")
        self.gridLayout.addWidget(self.axis_label_color_btn, 4, 1, 1, 2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.axis_label_color_btn.setText(_translate("Dialog", "Выбрать"))
        self.label_4.setText(_translate("Dialog", "Цвет подписей"))
