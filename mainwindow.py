...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.line, 0, 2, 15, 1)
        ...
        self.gridLayout.addWidget(self.output_box, 0, 4, 15, 1)
        ...
        self.gridLayout.addWidget(self.start_process_btn, 14, 0, 1, 2)
        ...
        self.substance_type_cb.addItem("")
        self.substance_type_cb.addItem("")
        self.gridLayout.addWidget(self.substance_type_cb, 2, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.stackedWidget, 0, 3, 15, 1)
        ...
        MainWindow.setTabOrder(self.substance_type_cb, self.f_le)
        MainWindow.setTabOrder(self.f_le, self.c0_le)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "Площадь кристалла (Sкр):"))
...
"состоянии (Cт)"))
        self.label_16.setText(_translate("MainWindow", "Динамическая вязкость (mu)"))
        self.label_17.setText(_translate("MainWindow", "Масса в долях (yi)"))
...
"примеси Co (cм^-3):"))
        self.label_21.setText(_translate("MainWindow", "Молярная масса приместого\n"
"компонента (mu_i)"))
...
"вещества (d)"))
        ...
        self.label_3.setText(_translate("MainWindow", "Оценка толщины диффузного слоя:"))
...
"(только у летучих примесей):"))
        ...
        self.label_14.setText(_translate("MainWindow", "Диаметр тигля:"))
        ...
        self.label_10.setText(_translate("MainWindow", "Плотность жидкости (ro)"))
